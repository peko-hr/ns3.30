...
{
  static TypeId tid = TypeId ("ns3::livelytower::TypeHeader")
                          .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::livelytower::RrepHeader")
                          .SetParent<Header> ()
                          .SetGroupName ("Livelytower")
...
{
  static TypeId tid = TypeId ("ns3::livelytower::HelloHeader")
                          .SetParent<Header> ()
                          .SetGroupName ("Livelytower")
