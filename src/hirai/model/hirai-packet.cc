...
{
  static TypeId tid = TypeId ("ns3::hirai::TypeHeader")
                          .SetParent<Header> ()
                          .SetGroupName ("Hirai")
...
TypeHeader::Deserialize (Buffer::Iterator start)
{
  ...
  switch (type)
    ...
    // case HIRAITYPE_RREP:
    // case HIRAITYPE_RERR:
    // case HIRAITYPE_RREP_ACK:
    case HIRAITYPE_SEND:
      case HIRAITYPE_HELLO: {
...
{
  static TypeId tid = TypeId ("ns3::hirai::HelloHeader")
                          .SetParent<Header> ()
                          .SetGroupName ("Hirai")
...
{
  static TypeId tid = TypeId ("ns3::hirai::SendHeader")
                          .SetParent<Header> ()
                          .SetGroupName ("Hirai")
