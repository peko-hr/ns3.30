 ...
 */
#ifndef LOWBATTERYPACKET_H
#define LOWBATTERYPACKET_H
...
*/
enum MessageType {
  LOWBATTERYTYPE_SEND = 1, //LOWBATTERY SEND
  LOWBATTERYTYPE_HELLO = 2 //LOWBATTERY HELLO
};

/**
* \ingroup lowbattery
* \brief LOWBATTERY types
*/
...
public:
  /**
   * constructor
   * \param t the LOWBATTERY RREQ type
   */
  TypeHeader (MessageType t = LOWBATTERYTYPE_HELLO);
  /**
...
//*******************************end Hello LOWBATTERY***********************************************/

//*******************************start send LOWBATTERY*********************************************/
/**
* \ingroup lowbattery
* \brief sendheader
  \verbatim
...
/********************************finish send LOWBATTERY*******************************************/

} // namespace lowbattery
} // namespace ns3

#endif /* LOWBATTERYPACKET_H */
