...
{
  static TypeId tid = TypeId ("ns3::lowbattery::TypeHeader")
                          .SetParent<Header> ()
...
TypeHeader::Deserialize (Buffer::Iterator start)
{
  ...
  switch (type)
    {
    // case LOWBATTERYTYPE_RREQ:
    // case LOWBATTERYTYPE_RREP:
    // case LOWBATTERYTYPE_RERR:
    // case LOWBATTERYTYPE_RREP_ACK:
    case LOWBATTERYTYPE_SEND:
      case LOWBATTERYTYPE_HELLO: {
...
{
  static TypeId tid = TypeId ("ns3::lowbattery::HelloHeader")
                          .SetParent<Header> ()
                          .SetGroupName ("Lowbattery")
...
// ***********************end LOWBATTERY_HELLO*************************************//

//***********************start LOWBATTERY Send*************************************//
...
{
  static TypeId tid = TypeId ("ns3::lowbattery::SendHeader")
                          .SetParent<Header> ()
                          .SetGroupName ("Lowbattery")
