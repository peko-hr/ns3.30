...
{
  static TypeId tid = TypeId ("ns3::lively::TypeHeader")
                          .SetParent<Header> ()
                          .SetGroupName ("Lively")
...
TypeHeader::Deserialize (Buffer::Iterator start)
{
  ...
  switch (type)
    {
    // case LIVELYTYPE_RREQ:
    // case LIVELYTYPE_RREP:
    // case LIVELYTYPE_RERR:
    // case LIVELYTYPE_RREP_ACK:
    case LIVELYTYPE_SEND:
      case LIVELYTYPE_HELLO: {
...
{
  static TypeId tid = TypeId ("ns3::lively::HelloHeader")
                          .SetParent<Header> ()
                          .SetGroupName ("Lively")
...
{
  static TypeId tid = TypeId ("ns3::lively::SendHeader")
                          .SetParent<Header> ()
                          .SetGroupName ("Lively")
