 ...
 */
#ifndef LOW-BATTERYROUTINGPROTOCOL_H
#define LOW-BATTERYROUTINGPROTOCOL_H

#include "low-battery-packet.h"
#include "ns3/node.h"
...
#define WindowSize 10000000 //LOW-BATTERYのウィンドウサイズ microsecond   = 10second
...
namespace ns3 {
namespace low-battery {
/**
 * \ingroup low-battery
 *
 * \brief LOW-BATTERY routing protocol
 */
...
public:
  ...
  static const uint32_t LOW-BATTERY_PORT;
...
private:
  ...
  void RecvLow-battery (Ptr<Socket> socket);
  ...
  void SendToLow-battery (Ptr<Socket> socket, Ptr<Packet> packet, Ipv4Address destination,
                        int32_t hopcount, int32_t des_id); //Low-battery broadcast の送信
  ...
  void
  SendLow-batteryBroadcast (int32_t pri_value, int32_t des_id, int32_t des_x, int32_t des_y,
...
#endif /* LOW-BATTERYROUTINGPROTOCOL_H */
