 ...
 */
#ifndef LOWBATTERYROUTINGPROTOCOL_H
#define LOWBATTERYROUTINGPROTOCOL_H

#include "lowbattery-packet.h"
#include "ns3/node.h"
...
#define WindowSize 10000000 //LOWBATTERYのウィンドウサイズ microsecond   = 10second
 ...
 * \ingroup lowbattery
 *
 * \brief LOWBATTERY routing protocol
 */
...
public:
  ...
  static const uint32_t LOWBATTERY_PORT;
...
private:
  ...
  void RecvLowbattery (Ptr<Socket> socket);
  ...
  void SendToLowbattery (Ptr<Socket> socket, Ptr<Packet> packet, Ipv4Address destination,
                        int32_t hopcount, int32_t des_id); //Lowbattery broadcast の送信
  ...
  void
  SendLowbatteryBroadcast (int32_t pri_value, int32_t des_id, int32_t des_x, int32_t des_y,
...
#endif /* LOWBATTERYROUTINGPROTOCOL_H */
