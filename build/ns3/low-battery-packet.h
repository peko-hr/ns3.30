 ...
 */
#ifndef LOW-BATTERYPACKET_H
#define LOW-BATTERYPACKET_H
...
*/
enum MessageType {
  LOW-BATTERYTYPE_SEND = 1, //LOW-BATTERY SEND
  LOW-BATTERYTYPE_HELLO = 2 //LOW-BATTERY HELLO
};

/**
* \ingroup low-battery
* \brief LOW-BATTERY types
*/
...
public:
  /**
   * constructor
   * \param t the LOW-BATTERY RREQ type
   */
  TypeHeader (MessageType t = LOW-BATTERYTYPE_HELLO);
  /**
...
//*******************************end Hello LOW-BATTERY***********************************************/

//*******************************start send LOW-BATTERY*********************************************/
/**
* \ingroup low-battery
* \brief sendheader
  \verbatim
...
/********************************finish send LOW-BATTERY*******************************************/

} // namespace low-battery
} // namespace ns3

#endif /* LOW-BATTERYPACKET_H */
