 ...
 */
#ifndef LIVELYROUTINGPROTOCOL_H
#define LIVELYROUTINGPROTOCOL_H

#include "lively-packet.h"
#include "ns3/node.h"
...
public:
  ...
  static const uint32_t LIVELY_PORT;
...
private:
  ...
  void RecvLively (Ptr<Socket> socket);
  ...
  void
  SendLivelyBroadcast (int32_t pri_value, int32_t des_id, int32_t des_x, int32_t des_y,
