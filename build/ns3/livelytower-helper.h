 ...
 */
class LivelytowerHelper : public Ipv4RoutingHelper
{
public:
  LivelytowerHelper ();

  /**
   * \returns pointer to clone of this LivelytowerHelper
   *
   * \internal
   ...
   *
   * This method controls the attributes of ns3::livelytower::RoutingProtocol
   */
